package com.xas.common.DbConfig;
...
@Configuration
@ComponentScan(basePackages={"com.xas.common.daoImpl","com.xas.common.serviceImpl"})
@EnableTransactionManagement
public class DatabaseConfig {
	
	private final String driverClass="com.mysql.jdbc.Driver";
	private final String jdbcUrl="jdbc:mysql://";
   ...
   /*  DriverManagerDataSource dataSource = new DriverManagerDataSource();
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/xascore");
